...
namespace ControleFinanceiro.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        {
            var controleFinanceiroDbContext = _context.Expense.Include(e => e.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,DueDate,Cost,Type,Status,UserId")] Expense expense)
        {
            if (id != expense.Id)
            {
                return NotFound();
