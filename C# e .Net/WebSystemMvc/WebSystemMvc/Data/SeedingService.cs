...
using WebSystemMvc.Models.Enums;

namespace WebSystemMvc.Data
{
    public class SeedingService
    {
        private WebSystemMvcContext _context;

        public SeedingService(WebSystemMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1323.23, d1);
            Seller s2 = new Seller(2, "Maria Green", "mari@hotmail.com", new DateTime(1979, 12, 11), 8314.93, d4);
            Seller s3 = new Seller(3, "Alex Grey", "lelex@hotmail.com", new DateTime(1975, 6, 17), 2852.64, d3);
            Seller s4 = new Seller(4, "Martha Red", "pllMarta@gmail.com", new DateTime(2001, 1, 28), 5009.61, d4);
            Seller s5 = new Seller(5, "Donald Blue", "dnb.007@hotmail.com", new DateTime(1987, 10, 3), 2105.44, d2);
            Seller s6 = new Seller(6, "Ryan Pink", "ryan42@gmail.com", new DateTime(1991, 8, 8), 3489.20, d2);
